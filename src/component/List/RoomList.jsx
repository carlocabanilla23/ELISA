...
const RoomList = ({items,updateList,ResortedList}) => {
            ...
            <div className="UserRowTitle">
                <div className="container-fluid">
                    <div className="row">   
                        ...
                        <div className="col" onClick={e => {ResortedList('amount',amount);reset('amount')}} style={{'cursor': 'pointer'}}> Number of Items</div> 
                    </div>
                </div>
            </div>
